...
kbl(table_combined, 
    align = "l") %>% 
    add_header_above(c(" " = 1, "Age group" = 3, "Research strategy" = 3),
                   bold = T)%>%  
...
own_header <- tibble(
  `Research Practice` = "<b>Own practices</b>",
  Women = "", Men = "", Qualitative = "", `Mixed-Methods` = "", Quantitative = ""
)

comu_header <- tibble(
  `Research Practice` = "<b>Community's practices</b>",
  Women = "", Men = "", Qualitative = "", `Mixed-Methods` = "", Quantitative = ""
)
...
# Renderizar tabla
kbl(tabla_final, align = "l", escape = FALSE) %>%
