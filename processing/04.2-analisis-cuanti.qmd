...
@zhu_openaccess_2020], as well as on the findings from the qualitative study.
...
social science disciplines, and to research centers and associative research projects. In
...
@fig-motivaciones depicts the incentives that researchers might have to
open their data, whereby the most valuable are networking, the dissemination of publicly funded data to the community,
and the increase of one's work visibility. 
...
@fig-motivaciones-grid shows that, while the dissemination of results is valued
