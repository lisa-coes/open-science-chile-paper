...
\author{Juan Carlos Castillo \and Kevin Carrasco \and Gabriel Cortés}
\date{}
\begin{document}
\maketitle
\begin{abstract}
...
\subsection{Open science in the social
sciences}\label{open-science-in-the-social-sciences}
...
\subsection{Main components of open science in the research
process}\label{main-components-of-open-science-in-the-research-process}
...
\subsection{Antecedents of open science policies in
Chile}\label{antecedents-of-open-science-policies-in-chile}
...
\section{Reserch methodology}\label{reserch-methodology}
...
We conducted 13 semi-structured interviews with empirical social science
researchers selected through simple random sampling based on
predetermined criteria. The sampling frame comprised all academics
awarded a Regular Fondecyt (National Fund for Scientific and
Technological Development) Project between 2018 and 2019 in the
following study groups: Anthropology and Archaeology, Economic and
Administrative Sciences, Legal and Political Sciences, Psychology, and
Sociology. To ensure sample diversity, we allocated quotas by sex and
study group, randomly selecting one or two participants per sex within
each group. Researchers were excluded if they were primarily engaged in
theoretical or philosophical research, biological anthropology,
archaeology, or neuroscience. Additionally, given the multidisciplinary
composition of the Sociology study group --- which includes researchers
from related fields such as social psychology and social work --- we
applied a randomization procedure to guarantee the inclusion of at least
one sociologist. The final sample composition is presented in
Table~\ref{tbl-qual-sample}.

\begin{longtable}[]{@{}
  >{\raggedright\arraybackslash}p{(\linewidth - 4\tabcolsep) * \real{0.8125}}
  >{\raggedright\arraybackslash}p{(\linewidth - 4\tabcolsep) * \real{0.0781}}
...
All participants provided written informed consent prior their
involvement in the study. The project was reviewed and approved by the
Ethics Committee of the Faculty of Social Sciences at University of
Chile. The interviews were conducted via video call, with a duration
ranging from forty minutes to one hour. We addressed topics such as
researchers' familiarity and knowledge about open science, their
engagement in open science practice, their attitudes of openness and
transparency practices, and the potential compulsory use of these
...
population or ``communities'' to research results. Some interviewees
also associate the concept with knowledge production, referring to the
involvement of participants, communities and stakeholders in the
research process; the use mixed (Sociology, qualitative); or
interdisciplinary (Anthropology, qualitative; Sociology, qualitative)
methods. Few refer to practices such as open data or publication in open
access journals.
...
referring to open science as a ``fever'' (Economics, quantitative) or as
an ``overly ambitions project'' (Political Science, Qualitative).
...
\paragraph{Open Results}\label{open-results}
...
researchers. First, there is an attitude of suspicion towards this type
of practices, considering it a mixture of altruism and personal interest
(Psychology, quantitative). Although scientific collaboration is valued
and desirable, it is recognized that it benefits the researcher by
increasing the number of citations. This suspicion of an instrumental
motivation, linked to funding policies, leads some researchers to
refrain from these practices. We also found that the existence of
non-dissemination clauses in many journals discourage the sharing of
results, although no researcher reported being sanctioned or audited for
sharing their publications. Beyond any concern, the high value placed on
the openness of results encourage researchers to share their
publications in academics social media or other platforms.
...
to what they describe as prohibitive fees. One participant captured the
structural dimension of this disparity:

\begin{tcolorbox}[enhanced jigsaw, opacityback=0, left=2mm, breakable, colframe=quarto-callout-color-frame, arc=.35mm, leftrule=.75mm, toprule=.15mm, bottomrule=.15mm, colback=white, rightrule=.15mm]

``{[}\ldots{]} the prices are absurd, very absurd. They are set for
someone who lives in Chicago or in Switzerland, and who earns
accordingly {[}\ldots{]} It is exclusionary; for us, it is absurd.''
(Psychology, quantitative)

\end{tcolorbox}

In light of this, it is questioned whether these initiatives truly
reflect the principles of open science, criticizing the role and market
power of large publishers. It is argued that these practices shift the
cost of access from users to researchers, and that they channel public
funds from a Global South country --- such as Chile --- to large Global
North publishers. This concern was expressed in particularly sharp terms
by one respondent:

\begin{tcolorbox}[enhanced jigsaw, opacityback=0, left=2mm, breakable, colframe=quarto-callout-color-frame, arc=.35mm, leftrule=.75mm, toprule=.15mm, bottomrule=.15mm, colback=white, rightrule=.15mm]

``What we are experiencing now is a shameful mechanism of capital
transfer from Global South states to the Global North {[}\ldots{]} Using
Chilean taxpayers' money to finance the publication of scientific
articles by companies that then sell these articles back to Chilean
universities, at the far-from-cheap price of 65 dollars per text.''
(Anthropology, qualitative)

\end{tcolorbox}

However, these views coexist with a more pragmatic perspective that
recognizes that, given the model is based on free peer review and sale
of access, someone must assume the cost of openness (Political Science,
mixed-methods).

Also, it was possible to identify a generally negative attitude towards
ANID's dissemination policy, as it is perceived as inadequate for the
dissemination of knowledge produced with public funds. Interviewees
report the rigidity of the policy to the extent that it makes it
difficult to carry out certain dissemination initiatives aimed at
non-academic audiences, such as the publications of podcasts. In
addition, it was highlighted that ANID's funding structure places a
...
public and decision-makers. On the contrary, the prioritization of
English-language paywalled journals is perceived as a ``transfer of
capital from the global South to the global North'' (anthropology,
qualitative). In this way, research funded with public resources is
published in paywalled journals to which national researchers or their
universities must pay --- usually with public funds --- in order to gain
access.
...
diversifying their research outputs. One of them is the ``sacrifice of
...
interviewees emphasized the role played by their universities, specially
through their libraries. For this reason, respondents indicated that
they had not experienced difficulties in accessing publications. Others
recognize that in Latin America the practice of accessing scientific
products such as preprints or working papers though informal mechanisms
or even piracy is widespread among researchers and provides yet another
mean of dealing with access problems without major consequences.

\paragraph{Design Transparency}\label{design-transparency}
...
social groups that are more often studied. Particularly in the case of
publicly funded research, most researchers showed a very positive
attitude towards data openness, and several pointed out that it should
be a stronger or mandatory requirement. Some even argued that data in
this type of research are public goods, and non-availability of data was
perceived as illegitimate hoarding.

However, some researchers question the obligation of data openness,
highlighting the personal investment and additional cost involved. They
argue that data are research property, at least temporarily, since their
production requires innovation, creativity, and the building of
relationship with subjects or institutions. For these researchers, data
production is therefore an intellectual production, not a simple
investment of public resources executed by the researcher. In addition,
there is a tension between open data and the pressure to publish, not
only because of the time the researcher must devote to opening data, but
also because of the pressure for scientific products with original and
novel questions and designs. Thus some researchers question the value of
open data, arguing that it is difficult to use public data in new ways
because it has already been used, as ilustrate the following quote:

\begin{tcolorbox}[enhanced jigsaw, opacityback=0, left=2mm, breakable, colframe=quarto-callout-color-frame, arc=.35mm, leftrule=.75mm, toprule=.15mm, bottomrule=.15mm, colback=white, rightrule=.15mm]

{[}\ldots{]} in social science {[}\ldots{]} the relationship with data
{[}is{]} a relationship that has meaning and is significant to the
extent that it is produced within the framework of these broader
research programs. {[}\ldots{]} There is a kind of fantasy --- that if
we release the data, and all the interviews and all the databases are
out there, `oh yes!' --- I mean, I think that scientific research has a
level of complexity, of specificity, that should raise an alert
{[}\ldots{]} about the fantasy that data and interviews are released,
and we are going to start producing a great deal of very valuable, very
meaningful knowledge.'' (Sociology, qualitative)
...
distinction between quantitative and qualitative research. On the one
hand, all researchers agreed that most quantitative data should not
require special ethical protocols or conditions of use, except for data
generated in special populations or in economics studies where the data
belong to private companies. On the other hand, the opening of
qualitative data faces significant challenges from the perspective of
respondents, such as protecting the identity of participants. It is
mentioned that even if it were possible to mobilize human resources for
data anonymization, the risk of harm to many communities exceed their
anonymity. In addition, the decontextualization of the data due the loss
of the relationship between the researcher and the communities limits
the analysis and discourages its use. However, It is noteworthy that
despite the perceived differences in the ease and relevance of openness
between qualitative and quantitative data, only two of the researchers
interviewed --- one qualitative and one quantitative --- had ever
practiced open data publication beyond editorial requirements and
sharing data directly with other researchers.

\paragraph{Analysis Transparency}\label{analysis-transparency}
...
reproducibility. On the other hand, the transparency of quantitative
analysis tends to be associated with the public or private availability
of analysis codes developed. It is noteworthy that in many cases this
availability tends to be requested by academic journals. Although it is
not fully addressed, it is possible to conclude that the greater use of
software for these procedures, compared to what happens in qualitative
research, tends to facilitate the consolidation of a set of practices
and attitudes more favorable to the transparency of analyses.

However, no researcher reported having openly published their analysis
code, as these are usually shared privately, throught academic networks
or personal contacts. The codes are described as \emph{tootbrushes} --
highly personal and not designed for public sharing -- a metaphor that
captures both their idiosyncratic nature and the absence of shared
standards for their publication:

\begin{tcolorbox}[enhanced jigsaw, opacityback=0, left=2mm, breakable, colframe=quarto-callout-color-frame, arc=.35mm, leftrule=.75mm, toprule=.15mm, bottomrule=.15mm, colback=white, rightrule=.15mm]

It is difficult {[}to understand someone else's code{]} {[}\ldots{]}
because a code is really like a toothbrush --- every person codes
differently.'' (Economics, quantitative)

\end{tcolorbox}

The perception is compounded by the gap between working code and
publishable code. As one researcher acknowledge, analysis scripts
developed in the course of a project are rarely conceived with external
audiencies in mind:

\begin{tcolorbox}[enhanced jigsaw, opacityback=0, left=2mm, breakable, colframe=quarto-callout-color-frame, arc=.35mm, leftrule=.75mm, toprule=.15mm, bottomrule=.15mm, colback=white, rightrule=.15mm]

We wrote that code in a certain way {[}\ldots{]} never thinking about
publishing it. That code is {[}\ldots{]} messy, in quotation marks
{[}\ldots{]} it is not a clean code, ready to be published.''
(Psychology, quantitative)

\end{tcolorbox}

In addition, ethical and methodological complications, as well as the
need for clarity and tidiness in the codes for them to be useful,
highlight the lack of a standard for their publication. Finally, it is
mentioned that in some disciplines, such as economics, researchers have
not migrated to open source software due to the persistence of the
widespread use of programs with payment barriers.
...
\citeproc{ref-zhu_openaccess_2020}{Zhu 2020}), as well as on the
...
\citeproc{ref-arslan_formr_2020}{Arslan, Walther, and Tata 2020}) .
Since it is integrated with RStudio (R + RMarkdown), it facilitates
collaborative work regardless of the length of the questionnaire. The
platform allows the questionnaire to be self-administered, either by
personal computers or by smartphones.
...
social science disciplines, and to research centers and associative
research projects. In addition, the survey was distributed through
social media and at academic events. In the end, 98 complete responses
were received. The description of the sample is presented in
Table~\ref{tbl-resumen}.

\begin{longtable}[]{@{}
  >{\raggedright\arraybackslash}p{(\linewidth - 8\tabcolsep) * \real{0.1656}}
  >{\raggedright\arraybackslash}p{(\linewidth - 8\tabcolsep) * \real{0.4847}}
  ...
  >{\raggedright\arraybackslash}p{(\linewidth - 8\tabcolsep) * \real{0.0552}}@{}}

\caption{\label{tbl-resumen}Quantitative Sample Description}
...
\pandocbounded{\includegraphics[keepaspectratio]{paper_files/figure-pdf/fig-cca-1.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{paper_files/figure-pdf/fig-cca-grid-1.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{paper_files/figure-pdf/fig-cca-grid-2.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{paper_files/figure-pdf/fig-prac-1.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{paper_files/figure-pdf/fig-prac-2.png}}
...
It is noteworthy that when the analysis is broken down into different
...
\pandocbounded{\includegraphics[keepaspectratio]{paper_files/figure-pdf/fig-prac-grid-1.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{paper_files/figure-pdf/fig-prac-grid-2.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{paper_files/figure-pdf/fig-prac-grid-3.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{paper_files/figure-pdf/fig-barreras-1.png}}
...
Figure~\ref{fig-motivaciones} depicts the incentives that researchers
might have to open their data, whereby the most valuable are networking,
the dissemination of publicly funded data to the community, and the
increase of one's work visibility.

\begin{figure}

\centering{

\pandocbounded{\includegraphics[keepaspectratio]{paper_files/figure-pdf/fig-motivaciones-1.png}}
...
Figure~\ref{fig-motivaciones-grid} shows that, while the dissemination
of results is valued transversally, there are groups where the valuation
of extrinsic motivations has a greater preponderance. In particular,
...
\pandocbounded{\includegraphics[keepaspectratio]{paper_files/figure-pdf/fig-motivaciones-grid-1.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{paper_files/figure-pdf/fig-motivaciones-grid-2.png}}
...
\paragraph{a. Attitudes towards Open Science
Measures}\label{a.-attitudes-towards-open-science-measures}
...
\pandocbounded{\includegraphics[keepaspectratio]{paper_files/figure-pdf/fig-val-1.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{paper_files/figure-pdf/fig-vca-grid-1.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{paper_files/figure-pdf/fig-vca-grid-2.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{paper_files/figure-pdf/fig-dona-1.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{paper_files/figure-pdf/fig-dona-grid-1.png}}
...
reproducible research in Social Sciences}
...
\pandocbounded{\includegraphics[keepaspectratio]{paper_files/figure-pdf/fig-reprod-1.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{paper_files/figure-pdf/fig-reprod-2.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{paper_files/figure-pdf/fig-vanid-grid-1.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{paper_files/figure-pdf/fig-vanid-grid-2.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{paper_files/figure-pdf/fig-vanid-grid-b-1.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{paper_files/figure-pdf/fig-vanid-grid-b-2.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{paper_files/figure-pdf/fig-vanid-2-1.png}}
